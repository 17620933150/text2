<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"E:\phpStudy\PHPTutorial\WWW\local.shop.com\public/../application/admin\view\role\index.html";i:1533130880;}*/ ?>
        ...
        <table class="tablelist">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td auth_ids_list="<?php echo $role['auth_ids_list']; ?>" ><a href="<?php echo url('/role/upd',['role_id'=>$role['role_id']]); ?>" class="tablelink">编辑</a> <a href="<?php echo url('/role/del',['role_id'=>$role['role_id']]); ?>" class="tablelink"> 删除</a></td>
                </tr>
