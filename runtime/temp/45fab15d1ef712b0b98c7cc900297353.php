<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"E:\phpStudy\PHPTutorial\WWW\local.shop.com\public/../application/admin\view\type\upd.html";i:1533217981;}*/ ?>
...
<div class="formbody">
    ...
    <form action="" method="post">
        ...
        <ul class="forminfo">
            <li>
                <label>类型名称</label>
                <input name="type_name" value="<?php echo $type['type_name']; ?>" placeholder="请输入类型名称" type="text" class="dfinput"/><i></i>
            </li>
            <li>
                <label>类型描述</label>
                <textarea name="mark" placeholder="请输入商品类型描述" class="textinput" id="" cols="" rows="">
                    <?php echo $type['mark']; ?>
                </textarea>
            </li>
...
<script>
    //定义匹配不可见字符正则
    var reg = /\s+/g
    var oldtext = $("textarea[name='mark']").val();
    //把正则匹配的替换成空字符
    var newText = oldtext.replace(reg,'');
    $("textarea[name='mark']").val(newText);
