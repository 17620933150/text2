<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"E:\phpStudy\PHPTutorial\WWW\local.shop.com\public/../application/admin\view\user\index.html";i:1533131429;}*/ ?>
        ...
        <table class="tablelist">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="<?php echo url('/user/upd',['user_id'=>$user['user_id']]); ?>" class="tablelink">查看</a> <a href="<?php echo url('/user/del',['user_id'=>$user['user_id']]); ?>" class="tablelink"> 删除</a></td>
                </tr>
