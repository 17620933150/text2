<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"E:\phpStudy\PHPTutorial\WWW\local.shop.com\public/../application/admin\view\index\top.html";i:1533037106;}*/ ?>
...
<body style="background:url(<?php echo config('admin_static'); ?>/images/topbg.gif) repeat-x;">
    ...
    <div class="topright">
        <ul>
            <li><a href="<?php echo url('/public/logout'); ?>" onclick="return confirm('确认退出')" target="_parent">退出</a></li>
        </ul>
        <div class="user">
