<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"E:\phpStudy\PHPTutorial\WWW\local.shop.com\public/../application/admin\view\user\upd.html";i:1533035408;}*/ ?>
    ...
    <div class="formbody">
        ...
        <form action="<?php echo url('/user/add'); ?>" method="post">
            <ul class="forminfo">
                <li>
                    <label>用户名</label>
                    <input name="username" placeholder="请输入用户名" type="text" class="dfinput" value="<?php echo $userData['username']; ?>" /><i>名称不能超过30个字符</i>
                </li>
                <li>
                    <label>密码</label>
 				...
 				<li>
                    <label>确认密码</label>
                    <input name="repassword" placeholder="请输入密码" type="text" class="dfinput" /><i></i>
 				</li>
			<li>
                    <label>&nbsp;</label>
